...
class Brick(pygame.sprite.Sprite):
    ...
    def __init__(self, color, width, height):
        ...
        # Pass in the color of the brick, and its x and y position,
        # width and height.
...
# This will be a list that will contain
# all the sprites we intend to use in our game.
...
while carryOn:
    ...
    if pygame.sprite.collide_mask(ball, paddle):
        ball.rect.x = x_ball - ball.velocity[0]
        ball.rect.y = y_ball - ball.velocity[1]
        ball.bounce()
        paddle_sound.play()
    ...
    pygame.draw.line(
        screen,
        LIGHTBLUE,
        [0, paddle.rect.y - 0.5 * y_size_paddle],
        [0, paddle.rect.y + 1.5 * y_size_paddle],
        4 * dx,
    )
    pygame.draw.line(
        screen,
        LIGHTBLUE,
        [WIDTH, paddle.rect.y - 0.5 * y_size_paddle],
        [WIDTH, paddle.rect.y + 1.5 * y_size_paddle],
        4 * dx,
    )
    ...
    # (For now we only have 2 sprites!)
